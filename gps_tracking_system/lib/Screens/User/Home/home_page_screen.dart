            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                () {
                        ...
                        itemBuilder: (context, index) {
                          return Card(
                            shape: RoundedRectangleBorder(
                                ...
                                side: _appointmentList[index].status == Status.ONGOING ?BorderSide(color: Colors.amber, width: 3) :  BorderSide(color: primaryDeepLightColor)),
                            elevation: 0,
                            child: Padding(
                              child: ListTile(
                                leading: Column(
                                ...
                                onTap: () {
                                  Navigator.of(context).pushNamed(
                                      "/appointment_info",
                                      arguments: _appointmentList[index]).then((
                                      _) {
                                    setState(() {
                                      requestAppointmentList();
                                    });
                  ...
                  ) : Text("No appointment", style: TextStyleFactory.p(),);
                }()
              ],
            ))));
  }
