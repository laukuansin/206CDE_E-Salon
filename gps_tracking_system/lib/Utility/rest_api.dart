...
class RestApi
{
  ...
  static Future<Map<String, dynamic>> addressToCoordinate(String address, String apiKey) async{
    address = URLEncoder.encodeURLParameter(address);
    String url = "https://maps.googleapis.com/maps/api/place/textsearch/json?query="+address+"&key=" + apiKey;
