<?php
    ...
    public function getPaymentDetail()
    {
        ...
        $appointmentID=isset($this->request->post['appointment_id'])?$this->request->post['appointment_id']:false;

        if($appointmentID)
        {
            $customerResult=$this->model_appointment_appointment->getAppointmentById($appointmentID);
            $serviceResult=$this->model_appointment_appointment->getServiceByAppointmentId($appointmentID);
