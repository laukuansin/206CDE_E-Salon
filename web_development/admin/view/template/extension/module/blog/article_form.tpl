                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                          <textarea name="article_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control" data-toggle="summernote"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['description'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="input-content<?php echo $language['language_id']; ?>"><?php echo $entry_content; ?></label>
                                        <div class="col-sm-10">
                                          <textarea name="article_description[<?php echo $language['language_id']; ?>][content]" placeholder="<?php echo $entry_content; ?>" id="input-content<?php echo $language['language_id']; ?>" class="form-control" data-toggle="summernote"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['content'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                          ...
                          <td class="text-left"><?php echo $entry_keyword; ?></td>
                              ...
                              <tr>
                                ...
                                <?php foreach($languages as $language) { ?>
                                      ...
                                      <?php $language_id = $language['language_id']; $store_id = $store['store_id']; ?>
                                        <input type="text" name="article_seo_url[<?php echo $store['store_id']; ?>][<?php echo $language_id; ?>]" value="<?php if(isset($article_seo_url[$store_id][$language_id])) { echo $article_seo_url[$store_id][$language_id]; } ?>" placeholder="<?php echo $entry_keyword; ?>" class="form-control" />
                                      </div>
                                      <?php if(isset($error_keyword[$store_id][$language_id])) { ?>
                                      <div class="text-danger"><?php echo $error_keyword[$store_id][$language_id]; ?></div>
                                      <?php } ?> 
                                  <?php } ?></td>
                              </tr>
                              <?php } ?>
