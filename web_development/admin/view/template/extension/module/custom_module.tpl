							...
							<div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
							  <div class="block<?php echo $module_row; ?>" <?php if (2 == $module['type']) { echo 'style="display:none"'; } ?>>
								  <table class="form">
								    ...
								    <tr>
								      <td>Block content:</td>
								      <td><textarea name="custom_module_module[<?php echo $module_row; ?>][block_content][<?php echo $language['language_id']; ?>]" id="block-content-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>" data-toggle="summernote"><?php echo isset($module['block_content'][$language['language_id']]) ? $module['block_content'][$language['language_id']] : ''; ?></textarea></td>
								    </tr>
								  </table>	
							  </div>
