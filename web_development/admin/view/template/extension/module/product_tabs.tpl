								...
								<div id="carousel-<?php echo $module_row; ?>-element-<?php echo $i; ?>" style="padding-top:20px">
									...
									<div id="tab-language-<?php echo $module_row; ?>-<?php echo $i; ?>-<?php echo $language['language_id']; ?>">
										...
										<div class="clearfix" style="padding-top: 20px">
											<textarea rows="0" cols="0" id="product_tabs_<?php echo $module_row; ?>_<?php echo $i; ?>_<?php echo $lang_id; ?>_html" name="product_tabs[<?php echo $module_row; ?>][tabs][<?php echo $i; ?>][<?php echo $lang_id; ?>][html]"  data-toggle="summernote"><?php if(isset($item[$lang_id]['html'])) { echo $item[$lang_id]['html']; } ?></textarea>
										</div>
									</div>
									<?php } ?>
								</div>
